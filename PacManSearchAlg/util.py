...
def raiseNotDefined():
    fileName = inspect.stack()[1][1]    # get information  from live object
    line = inspect.stack()[1][2]    # get information  from live object
    method = inspect.stack()[1][3]  # get information  from live object
